...
const About = () => {
  return (
    <div className="p-36 min-h-screen bg-slate-200 py-10 flex flex-col items-center space-y-10">
      ...
      <div className="w-[50%] bg-white rounded-lg shadow-lg p-6 self-start flex">
      ...
      <div className="w-[50%] bg-white rounded-lg shadow-lg p-6 self-end flex">
      ...
      <div className="w-[80%] bg-white rounded-lg shadow-lg p-6 text-center">
