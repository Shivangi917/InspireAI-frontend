...
const About = () => {
  return (
    <div className="p-52 min-h-screen bg-slate-200 py-10 flex flex-col items-center space-y-10">

      {/* Feature 1: Left-aligned */}
      <div className="w-[60%] bg-white rounded-lg shadow-lg p-6 self-start flex">
          <h2 className="text-2xl font-semibold m-auto pr-6">Project Recommendations</h2>
          <p className="text-gray-700 border-l-2 border-gray-300 p-2">
      ...
      <div className="w-[60%] bg-white rounded-lg shadow-lg p-6 self-end flex">
        <p className="text-gray-700 border-r-2 border-gray-300 p-2">
        ...
        <h2 className="text-2xl font-semibold m-auto pl-6">Tailored Feedback</h2>
      </div>

      {/* Feature 3: Left-aligned */}
      <div className="w-[60%] bg-white rounded-lg shadow-lg p-6 self-start flex">
        <h2 className="text-2xl font-semibold m-auto pl-6">Stay Ahead of Trends</h2>
        <p className="text-gray-700 m-auto border-l-2 border-gray-300 p-2">
      ...
      <div className="w-[100%] bg-white rounded-lg shadow-lg p-6 text-center">
